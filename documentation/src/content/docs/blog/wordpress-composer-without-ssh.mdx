...
draft: false
cliVersion: 0.17.0
wordpressPluginVersion: 2026.7.10
authors:
  - maxime
tags:
  - composer
...
Loopress Full is a free download, installed like any other plugin zip (**Plugins → Add New → Upload Plugin**), no server configuration required. If you only need ACF and SEO sync, Loopress Light is the free edition on the wordpress.org directory instead.
