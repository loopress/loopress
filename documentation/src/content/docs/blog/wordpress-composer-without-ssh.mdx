...
import composerInstallVideo from '../../../assets/composer-install-admin-ui.webm';
...
Here's the whole flow, in under a minute:
...
4. Require the autoloader once, then use the package in a code snippet:
