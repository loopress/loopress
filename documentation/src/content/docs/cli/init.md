...
| Other features | Optional multi-select for ACF, SEO, Forms, custom API routes, and single-page apps. Only the features you pick get their directory written to `loopress.json` (defaults: `acf`, `seo`, `forms`, `api`, `apps`). |
