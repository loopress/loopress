...
{
    $endpoint = wp_json_encode(esc_url_raw(rest_url('loopress-api/v1/graphql')));
    ...
    <script type="module">
      ...
      createRoot(document.getElementById('graphiql')).render(React.createElement(GraphiQL, { fetcher }));
    </script>
    HTML;
    exit;
}
