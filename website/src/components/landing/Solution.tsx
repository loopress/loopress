...
const PILLARS = [
  ...
  {
    t: "Plugin Lockfile",
    d: "Declare plugin versions in loopress.json and sync any environment with one command.",
  },
  {
    t: "Composer without SSH",
    d: "Search and install Packagist packages from the WordPress admin panel.",
  },
];
