...
composer psalm
composer cs         # phpcs
pnpm pack           # builds both editions: loopress-light.zip and loopress.zip
pnpm pack:light     # loopress-light.zip only
pnpm pack:full      # loopress.zip only
```
